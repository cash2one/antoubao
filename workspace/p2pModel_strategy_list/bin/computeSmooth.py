...
if len(sys.argv) < 2:
    ...
    for platid in scored.keys():
        ...
        for timestamp in scored[platid]:
            ...
            result[platid][timestamp]["score_after_punishment"] = scored[platid][timestamp]["score"]
            result[platid][timestamp]["level_after_punishment"] = scored[platid][timestamp]["level"]
