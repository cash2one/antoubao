...
if __name__ == '__main__':
    ...
    # 获取连接    
    srcdb_info = "project_info_clean_whole"
...
#         #新添weekly_lending_adjust字段
#         for bidID in platforms_bids[platform_id]:
#             bidTemp = platforms_bids[platform_id][bidID]
#             if bidTemp["loan_period"] > DAYBIDMAX:
#                 history_time_node = date_list.index(bidTemp["date"]) 
#                 weekly_lending_adjust[history_time_node] += bidTemp["borrowing_amount"]
