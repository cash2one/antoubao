...
hehePunish = {'21bc62c397':2, '8e1490acae':2, 'c3b60ff4b8':4, 'f696acef8b':2, 'adec69a9ff':1, '572c99f5ad':2, '1f7b2591d7':5, 'e5bf6ac10d':4, '898b7ab68e':7, '9191dff111':2.5, 'c38f13eb81':5.55, '05f75f9e85':18.5, '860caca812':8, 'f75d96fcde':-6.5, '4de3888a61':-5.5, '988e0d4d9d':5.5}
#呵呵黑名单，米牛网、658金融城、金联储、金融工场、小企业e家
BLACKLIST = ['209c2758e2', 'fad64286c7', 'b6a08f5df6']
#各个级别的百分比
LEVEL_PERCENTAGE_DICT = {"A++":98, "A+":81.3, "A":64.5, "B++":46.5, "B+":20.1987, "B":5.9}