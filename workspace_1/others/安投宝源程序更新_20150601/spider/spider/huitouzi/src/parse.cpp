...
int parsefile(const char *idstr)
{
    ...
    kv["site_id"] = "huitouzi";
//    kv["borrower"] = "";
    kv["project_name"] = extract(bstr, "class=\"breadcrumb\">", "首页", "<li>", "</a>");
    kv["project_id"] = idstr;
//    kv["borrowing_amount"] = ;
    kv["annulized_rating"] = extract(bstr, "class=\"info-tab\">", "预期年化收益率：", "<p>", "%");
    kv["payment_method"] = extract(bstr, "class=\"stab\">", "还款方式：", "<span>", "</span>");
    kv["loan_period"] = loanperiod_util(extract(bstr, "class=\"stab\">","理财期限：", "<p>", "</p>"));
//    kv["release_time"] = "";    
