...
//    kv["borrower"] = extract(bstr, "", "div class=\"pd_content1\">", "","</div>");
    kv["project_name"] = extract(bstr,"<div class=\"col-md-9\">","<h3>","","<");
    kv["project_id"] = idstr;
    kv["borrowing_amount"] = num_util(extract(bstr, "投资金额", "</span>","","</li>"));
...
//	kv["release_time"] = longtostring(stringtotime(extract(bstr,"起投时间","：","","</div>").c_str(),"%Y-%m-%d %H:%M"));
    ...
    kv["payment_method"] = extract(bstr,"<div class=\"col-md-9\">","<h3>","\">","<");
    kv["loan_period"] = loanperiod_util(extract(bstr, "投资期限", "<span", "\">","<i"));
