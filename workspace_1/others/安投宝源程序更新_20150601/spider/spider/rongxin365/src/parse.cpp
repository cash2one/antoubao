...
int parsefile(const char *idstr)
{
    ...
    kv["site_id"] = "rongxin365";
    kv["project_name"] = extract(bstr, "<head>", "<meta charset=", "<title>"," - ");
    kv["borrower"] = extract(bstr,"<div class=\"avatar\">","<img src="," alt=\"","\">");
    kv["project_id"] = extract(bstr,"<div style=","借贷编号：","\">","</span></div>");
    kv["borrowing_amount"] = extract(bstr,"<tr height=\"40px\">","<b class=","￥","</b>");
    ...
    kv["annulized_rating"] = filternum(extract(bstr,"￥","\">", "\">", "%</b>"));
    kv["payment_method"] = extract(bstr,"<td colspan=","还款方式","\"> ","</span>");
    kv["loan_period"] = extract(bstr, "<tr height=", "￥", "\">","</td>");
