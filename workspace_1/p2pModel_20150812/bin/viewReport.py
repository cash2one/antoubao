...
for platId, date in DEVCUR.fetchall():
    platId = platId[:-1]
    #报告发布时间
    reportDate = int(date)+7*24*3600*2
    #线图时间
    ...
    stringSQL = "INSERT INTO "+DSTDB+"(`platform_id`, `platform_name`, `date`, `show`, `type`, `platform_id_list`, `date_list`, `property`, `title`, `unit`) VALUES('"+platId+"', '"+platName+"', '"+str(date)+"', '0', 'line', '"+platId+"', '"+str(firstDate)+","+str(lastDate)+"', 'top5_ratio_investment', '前五大投资人集中度', '人')"
    DEVCUR.execute(stringSQL)

    stringSQL = "INSERT INTO "+DSTDB+"(`platform_id`, `platform_name`, `date`, `show`, `type`, `platform_id_list`, `date_list`, `property`, `title`, `unit`) VALUES('"+platId+"', '"+platName+"', '"+str(date)+"', '0', 'line', '"+platId+"', '"+str(firstDate)+","+str(lastDate)+"', 'top10_ratio_investment', '前十大投资人集中度', '人')"
    DEVCUR.execute(stringSQL)
